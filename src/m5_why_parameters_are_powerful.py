...
def main():
    ...
    #even_better_draw_circles(rg.Point(-50, 300), 15, 3, 'red', 10)

    even_better_draw_circles(rg.Point(50, 0), 15, 40, 'red', 2)
    even_better_draw_circles(rg.Point(0, 50), 15, 30, 'green', 10)
    even_better_draw_circles(rg.Point(-50, 0), 15, 40, 'red', 2)
    even_better_draw_circles(rg.Point(0, -50), 15, 30, 'green', 10)
...
def even_better_draw_circles(point, radii, circlenumber, color, thickness):
    ...
    for k in range(1, circlenumber + 1):  # k becomes 1, 2, 3, ... 10
