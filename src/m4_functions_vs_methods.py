...
def try_methods():
    ...
    ###########################################################################
    tboi = rg.SimpleTurtle()
    tboi.pen = rg.Pen('brown', 5)
...
def try_methods_and_functions():
    ...
    ###########################################################################
    strangeboi = rg.SimpleTurtle()
    strangeboi.pen = rg.Pen('blue', 5)

    strangeboi.backward(150)

    strangeboi.speed = 1
    draw_many_squares(strangeboi, 2, 100, 30)

    strangeboi.speed = 5
    strangeboi.pen = rg.Pen('red', 5)
    draw_many_squares(strangeboi, 10, 50, 15)

    strangeboi.speed = 100
    strangeboi.pen = rg.Pen('red', 35)
    draw_many_squares(strangeboi, 8, 300, 60)

    strangeboi.pen = rg.Pen('black', 3)

    strangeboi.backward(200)

    strangeboi.draw_circle(30)

    strangeboi.draw_square(50)
