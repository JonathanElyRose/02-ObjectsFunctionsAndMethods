...
#
###############################################################################
def triangleboi(length1, length2):
    return(((length1 ** 2)+(length2 ** 2)) ** (1/2))
...
#
###############################################################################
def turtleboi(givenColor, givenThickness):
    window = rg.TurtleWindow()

    thickboi = rg.SimpleTurtle()
    thickboi.pen = rg.Pen('green', givenThickness)

    colorboi = rg.SimpleTurtle()
    colorboi.pen = rg.Pen(givenColor, 5)

    thickboi.forward(100)
    colorboi.backward(100)
